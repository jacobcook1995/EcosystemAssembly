    ...
    for i = 1:rps
        ...
        while Rn_end == false
            ...
            if Tind > 1 && tsvt[Tind-1] != 0
                ...
                cmb_pop[i, cnt] = interpolate_time(pop, Tg, T1x, T2x)
                cmb_via_bm[i, cnt] = interpolate_time(via_bm, Tg, T1x, T2x)
                cmb_shD[i, cnt] = interpolate_time(shD, Tg, T1x, T2x)
                cmb_sbs[i, cnt] = interpolate_time(sbs, Tg, T1x, T2x)
                cmb_ηs[i, cnt] = interpolate_time(ηs, Tg, T1x, T2x)
                cmb_via_η[i, cnt] = interpolate_time(via_η, Tg, T1x, T2x)
                cmb_via_η_bw[i, cnt] = interpolate_time(via_η_bw, Tg, T1x, T2x)
                cmb_ωs[i, cnt] = interpolate_time(ωs, Tg, T1x, T2x)
                cmb_via_ω[i, cnt] = interpolate_time(via_ω, Tg, T1x, T2x)
                cmb_via_ω_bw[i, cnt] = interpolate_time(via_ω_bw, Tg, T1x, T2x)
                cmb_fr_ΔG[i, cnt] = interpolate_time(fr_ΔG, Tg, T1x, T2x)
                cmb_fr_ΔG_bw[i, cnt] = interpolate_time(fr_ΔG_bw, Tg, T1x, T2x)
                cmb_via_a[i, cnt] = interpolate_time(via_a, Tg, T1x, T2x)
                cmb_via_ϕR[i, cnt] = interpolate_time(via_ϕR, Tg, T1x, T2x)
                cmb_kcs[i, cnt] = interpolate_time(kcs, Tg, T1x, T2x)
                cmb_KSs[i, cnt] = interpolate_time(KSs, Tg, T1x, T2x)
                cmb_krs[i, cnt] = interpolate_time(krs, Tg, T1x, T2x)
                cmb_av_steps[i, cnt] = interpolate_time(av_steps, Tg, T1x, T2x)
                cmb_av_steps_bw[i, cnt] = interpolate_time(av_steps_bw, Tg, T1x, T2x)
                ...
                for j = 1:NoR
                    ...
                    cmb_ωs_R[i, j, cnt] = interpolate_time(ωs_R[j, :], Tg, T1x, T2x)
                    cmb_kc_R[i, j, cnt] = interpolate_time(kc_R[j, :], Tg, T1x, T2x)
                    cmb_KS_R[i, j, cnt] = interpolate_time(KS_R[j, :], Tg, T1x, T2x)
                    cmb_kr_R[i, j, cnt] = interpolate_time(kr_R[j, :], Tg, T1x, T2x)
                end
            else
