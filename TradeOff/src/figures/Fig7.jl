...
function figure7(rps::Int64)
    ...
    e7 = L"10^7"
    em3 = L"10^{-3}"
    plot!(p2,times/1e7,mn_KS_R[1,:]*1000.0,ribbon=se_KS_R[1,:]*1000.0,label="R=1",color=a[1],inset_subplots=box,subplot=2)
    plot!(p2,times/1e7,mn_KS_R[3,:]*1000.0,ribbon=se_KS_R[3,:]*1000.0,label="R=3",color=a[2],subplot=2)
    plot!(p2,times/1e7,mn_KS_R[5,:]*1000.0,ribbon=se_KS_R[5,:]*1000.0,label="R=5",color=a[3],subplot=2)
    plot!(p2,times/1e7,mn_KS_R[7,:]*1000.0,ribbon=se_KS_R[7,:]*1000.0,label="R=7",color=a[4],subplot=2)
    plot!(p2,xlim=(-Inf,0.25),guidefontsize=9,grid=false,legend=false,subplot=2)
