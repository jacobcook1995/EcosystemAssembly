...
function plot_aves()
    ...
    plot(xlabel="Time (s)",ylabel="Average number of competitive interactions",xlim=(-Inf,5e7))
    plot!(times,mn_no_comp,ribbon=se_no_comp,label="")
    savefig("Output/AvNoCompTime.png")
    plot(xlabel="Time (s)",ylabel="Average number of facilitation interactions",xlim=(-Inf,5e7))
    plot!(times,mn_no_facl,ribbon=se_no_facl,label="")
    savefig("Output/AvNoFaclTime.png")
    plot(xlabel="Time (s)",ylabel="Average number of self-facilitation interactions",xlim=(-Inf,5e7))
    plot!(times,mn_no_self,ribbon=se_no_self,label="")
    savefig("Output/AvNoSelfTime.png")
    plot(xlabel="Time (s)",ylabel="Average strength of competitive interactions",xlim=(-Inf,5e7))
    plot!(times,mn_st_comp,ribbon=se_st_comp,label="")
    savefig("Output/AvStCompTime.png")
    plot(xlabel="Time (s)",ylabel="Average strength of facilitation interactions",xlim=(-Inf,5e7))
    plot!(times,mn_st_facl,ribbon=se_st_facl,label="")
    savefig("Output/AvStFaclTime.png")
    plot(xlabel="Time (s)",ylabel="Average strength of self-facilitation interactions",xlim=(-Inf,5e7))
