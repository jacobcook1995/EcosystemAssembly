...
function generate_test_microbe()
    ...
    test_microbe = make_MicrobeP(MC, γm, ρ, Kγ, Pb, d, ϕH, KΩ, fd, R, Reacs, η, kcs, KSs,
        krs, n, ϕP)
    return test_microbe
end
...
@testset "Test ϕ_R function" begin
    @test ϕ_R(1e6, microbe) == 0.0005494505494505495
    @test ϕ_R(2.5e5, microbe) == 0.0001374656335916021
