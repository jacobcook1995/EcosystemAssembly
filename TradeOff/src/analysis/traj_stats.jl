...
function trjstats()
    ...
    cmb_ηs = zeros(rps,NoR,length(times))
    cmb_no_comp = zeros(rps,NoR,length(times))
    cmb_no_facl = zeros(rps,NoR,length(times))
    cmb_no_self = zeros(rps,NoR,length(times))
    cmb_st_comp = zeros(rps,NoR,length(times))
    cmb_st_facl = zeros(rps,NoR,length(times))
    cmb_st_self = zeros(rps,NoR,length(times))
