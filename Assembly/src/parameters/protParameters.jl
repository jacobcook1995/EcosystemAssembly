...
"""
    ProtParameters(MC::Int64,γm::Float64,T::Float64,η::Float64,r::Reaction,n::Array{Int64,1})
...
"""
    make_ProtParameters(MC::Int64,γm::Float64,T::Float64,η::Float64,r::Reaction,n::Array{Int64,1})
...
"""
function make_ProtParameters(MC::Int64,γm::Float64,T::Float64,η::Float64,r::Reaction,n::Array{Int64,1})
    ...
    return(ProtParameters(MC,γm,T,η,r,n))
end
