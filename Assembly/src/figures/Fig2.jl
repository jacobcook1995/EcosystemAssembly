...
function ent_sp_cnt(ps::FullParameters,C::Array{Float64,2},T::Array{Float64,1},Ns::Int64,
                    out::Array{Float64,1},inf_out::Array{Float64,1},ded::Array{MicrobeP,1})
...
function figure2(Rl::Int64,Ru::Int64,syn::Bool,Nr::Int64,Ns::Int64,en::String,Tf::Float64,rps::Int64)
    ...
    scatter!(p4,xdataT,ydataT,ms=6,color=:black,label="",inset_subplots=box,subplot=2)
    ...
    plot!(p4[2],xlabel="Entropy production peaks",ylabel="New metabolites",ylim=(0,25),xlim=(0,25))
