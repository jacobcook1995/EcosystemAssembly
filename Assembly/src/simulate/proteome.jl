...
# proteome fraction model. Once I'm satisfied with it I will incorporate it into
# the main model
...
function p_dynamics!(dx::Array{Float64, 1}, x::Array{Float64, 1}, pa::Array{Int64, 1},
                     ps::ProtParameters, t::Float64)
...
# Simulation code to run one instance of the simulation
...
function p_dynamics_fix!(dx::Array{Float64, 1}, x::Array{Float64, 1}, pa::Array{Int64, 1},
                         ps::ProtParameters, t::Float64)
    # Based on energy level find growth rate λ
    λ = λs(x[2], x[5], ps)
    # Then find amount of enzyme
...
function p_dynamics_fix_na!(dx::Array{Float64, 1}, x::Array{Float64, 1},
                            pa::Array{Int64, 1}, ps::ProtParameters, t::Float64)
    # Based on energy level find growth rate λ
    λ = λs(x[2], x[5], ps)
    # Then find amount of enzyme
    E = Eα(1 - x[5] - ps.ϕH, ps)
